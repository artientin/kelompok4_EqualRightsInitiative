  ...
  <div class="container mb-5">
    <figure class="text-center">
        ...
        <div class="mb-3">
            ...
            <input type="radio" id="gender" name="gender1"> Laki-Laki
            <input type="radio" id="gender" name="gender2"> Perempuan
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="no_identitas" placeholder="Masukkan Nomor Identitas">
        </div>
        <div class="mb-3">
            <label for="file_identitas" class="form-label">Unggah Identitas Pelapor</label>
            <input type="file" class="form-control" id="file_identitas">
        </div>
        <div class="mb-3">
            <label for="domisli" class="form-label">Alamat Domisli</label>
            <textarea class="form-control" id="domisli" rows="3" placeholder="Masukkan Alamat Domisli"></textarea>
        </div>
        <div class="mb-3">
            <label for="telepon" class="form-label">Nomor Telepon/Ponsel Pelapor</label>
            <input type="text" class="form-control" id="telepon" placeholder="Masukkan Nomor Telepon/Ponsel">
        </div>
        <div class="mb-3">
            <label for="fax" class="form-label">Nomor Fax Pelapor</label>
            <input type="text" class="form-control" id="fax" placeholder="Masukkan Nomor Fax">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="perihal" rows="3" placeholder="Ceritakan Kejadian Secara Rinci"></textarea>
        </div>
        <div class="mb-3">
            <label for="lokasi" class="form-label">Lokasi Kejadian</label>
            <textarea class="form-control" id="lokasi" rows="3" placeholder="Masukkan Lokasi Kejadian Secara Rinci"></textarea>
        </div>
        <div class="mb-3">
            <label for="tanggal" class="form-label">Tanggal dan Waktu Kejadian</label>
            <textarea class="form-control" id="tanggal" rows="3" placeholder="Uraikan Tanggal dan Waktu Kejadian"></textarea>
        </div>
        <div class="mb-3">
            <label for="harapan" class="form-label">Harapan Pengadu</label>
            <textarea class="form-control" id="harapan" rows="3" placeholder="Tuliskan Harapan Pengadu"></textarea>
        </div>
        <div class="mb-3">
            <label for="file_pendukung" class="form-label">Lampiran Dokumen Pendukung</label>
            <input type="file" class="form-control" id="file_pendukung">
        </div>
        <button type="button" class="btn btn-primary">Buat Aduan</button>
    </div>
