...
if (isset($_POST['buat'])){
  mysqli_query($conn, "INSERT INTO pengadu SET
  nama = '$_POST[nama]',
  ...
  mysqli_query($conn, "INSERT INTO kejadian SET
...
<body class="sub_page">
    ...
    <div class="container mb-5">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" name="domisli" rows="3" placeholder="Masukkan Alamat Domisli"></textarea>
        </div>
        <div class="mb-3">
            <label for="nomor_telepon" class="form-label">Nomor Telepon/Ponsel Pelapor</label>
            <input type="text" class="form-control" name="nomor_telepon" placeholder="Masukkan Nomor Telepon/Ponsel">
        </div>
        <div class="mb-3">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3 ">
                        <div class="info_detail">
                            ...
                            <p>
                                Menyediakann layananan bagi masyarakat yang ingin menyampaikan atau memberitahukan
                                masalahnya.
                            </p>
                        </div>
                    </div>
