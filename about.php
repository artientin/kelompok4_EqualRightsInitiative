      ...
      <div class="row">
        <div class="col-md-6">
          <div class="detail-box">
            ...
            <p>
              Alasan pengembangan aplikasi ini didorong oleh masalah-masalah yang muncul yang mengancam Hak Asasi Manusia (HAM). Aplikasi ini masih dalam tahap pengembangan dan mungkin kedepannya akan tetap dikembangkan untuk membantu masyarakat yang mengalami masalah Hak Asasi Manusia (HAM).
            </p>
            <a href="label.php">
              Baca Selengkapnya
            </a>
