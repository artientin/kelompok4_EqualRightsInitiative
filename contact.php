        ...
        <div class="col-md-5 col-lg-4 offset-md-1">
          <div class="form_container">
            ...
            <form action="" method="POST">
              ...
              <div>
                <input type="text" id="telpon" name="telpon" placeholder="Nomor Telepon" />
              </div>
              <div>
                <input type="text" id="pesan" name="pesan" class="message-box" placeholder="Pesan" />
              </div>
              <div class="d-flex ">
