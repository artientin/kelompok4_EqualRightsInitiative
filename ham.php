...
<body class="sub_page">
  ...
  <div class="container">
    <div class="row text-center mb-3">
        <div class="col">
            <br>
            <h5><b>MANUSIA - HAK ASASI<br>
            1999<br>
            UU NO. 39, LN 1999 / NO. 165, TLN. NO. 3886, LL SETKAB : 45 HLM.<br>
            UNDANG-UNDANG TENTANG HAK ASASI MANUSIA</b></h5>
        </div>
    </div>
  </div>
  ...
  <div class="row justify-content-center">
    <div class="col-8">
        ...
        <h6>CATATAN :</h6>
        <br>
        <p>- Undang-Undang ini mulai berlaku sejak diundangkan pada tanggal 23 September 1999.</p>
        <p>- Dalam waktu paling lama 2 (dua) tahun sejak berlakunya Undang-undang ini susunan organisasi, keanggotaan, tugas dan wewenang serta tata tertib Komnas HAM harus disesuaikan dengan Undang-undang ini.</p>
        <p>- Undang-undang ini terdiri dari 11 Bab dan 106 Pasal</p>
        <p>- Penjelasan 16 hlm.</p>
    </div>
  </div>
  <!-- end ham section -->
